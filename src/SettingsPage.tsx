...
export function SettingsPage({ setNotice }: { setNotice: (value: string) => void }) {
  ...
  return <section className="settings-page"><div className="library-intro"><div><p>MEDIA FEATURES</p><h2>Subtitles</h2><span>Automatic transcription and private local translations inside Open EasyX</span></div></div>
